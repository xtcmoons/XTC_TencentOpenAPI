#
#  Be sure to run `pod spec lint XTCTencentOpenAPI_iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "XTCTencentOpenAPI_iOS"
  s.version      = "3.1.3"
  s.summary      = "TencentOpenAPI iOS"
...
#s.description  = <<-DESC
  ...
  s.homepage     = "https://github.com/xtcmoons/XTC_TencentOpenAPI"
  ...
  s.source       = { :git => "https://github.com/xtcmoons/XTC_TencentOpenAPI.git", :tag => s.version }
